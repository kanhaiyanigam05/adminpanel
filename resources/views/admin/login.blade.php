...
<head>
    ...
    <title>Alpha Consulting and Coaching</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="../assets/img/IconicFuture_logo.png" rel="icon">
    <link href="../assets/img/IconicFuture_logo.png" rel="apple-touch-icon">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="{{ route('admin.dashboard') }}" class="logo d-flex align-items-center w-auto">
                                    <img src="assets/img/IconicFuture_logo.png" alt="">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.login') }}" method="POST">
                                        ...
                                        <div class="col-12 mt-3">
                                            <button class="btn btn-primary w-100" name="loginsubmit"
